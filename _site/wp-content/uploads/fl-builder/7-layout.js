...
else{module.addClass('fl-animated');}}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='http://localhost/new_yohanbelmin/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/new_yohanbelmin/wp-content/plugins/bb-plugin/';